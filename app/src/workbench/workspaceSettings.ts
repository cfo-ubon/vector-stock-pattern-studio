...
export type RightPanelId = 'inspector' | 'marketplace' | 'prompt' | 'quality' | 'critic' | 'evolution' | 'validation' | 'preview' | 'history';
...
export const RIGHT_PANEL_IDS: RightPanelId[] = ['inspector', 'marketplace', 'prompt', 'quality', 'critic', 'evolution', 'validation', 'preview', 'history'];
