...
| P2.5-10 | No crash-recovery certification, no interrupted-migration recovery, no corrupted-database-recovery testing | Explicitly out of scope per the Sprint 2 brief (belongs to a Sprint 3 recovery-certification stage) | Sprint 3's own scope decision — not started here |
